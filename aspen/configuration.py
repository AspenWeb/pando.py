"""Define configuration objects.
    ...
    3. ConfFile -- represents a configuration file
...
class Configuration(object):
    ...
    def __init__(self, argv):
        ...
        conf = ConfFile(os.path.join(root, '.aspen', 'etc', 'aspen.conf'))
        ...
        autoindex = self.conf.main.get('autoindex', 'yes').lower()
        if autoindex not in YES + NO:
            raise ConfigurationError("autoindex should be 'yes' or 'no'")
        self.autoindex = autoindex in YES
