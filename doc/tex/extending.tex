...
% At run-time, applications and handlers can access the current \class{Website}
% and \class{Configuration} instances by importing \code{aspen.website} and
% \code{aspen.configuration} respectively.
