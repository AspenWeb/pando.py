...
for entrypoint in pkg_resources.iter_entry_points(group='pando.renderers'):
...
def factories(configuration):
    ...
    for name in BUILTIN_RENDERERS:
        ...
        try:
            capture = {}
            python_syntax = 'from pando.simplates.renderers.%s import Factory'
